...
{
    const string FOLDER_REPLACE_POLICY_AUTO_RENAME = 'AUTO_RENAME';
    const string FOLDER_REPLACE_POLICY_MERGE = 'MERGE';
    const string FOLDER_REPLACE_POLICY_THROW_EXCEPTION = 'THROW_EXCEPTION';
